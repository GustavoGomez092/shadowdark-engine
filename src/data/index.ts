...
export const getSpellsByClass = (c: 'wizard' | 'priest') => dataRegistry.getSpellsByClass(c)
export const getSpellsByTier = (t: number) => dataRegistry.getSpellsByTier(t)
export const getSpellsByClassAndTier = (c: 'wizard' | 'priest', t: number) => dataRegistry.getSpellsByClassAndTier(c, t)
