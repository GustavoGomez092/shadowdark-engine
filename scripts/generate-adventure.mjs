...
const monsters = [
    ...
    abilities: [
      {
        ...
        description: 'Cuando la Masa muere, emite un grito que obliga a todas las criaturas en rango cercano a tirar WIS DC 11 o quedar aturdidas 1 ronda.',
      },
      {
    ...
    abilities: [
      {
        ...
        description: 'Si la Araña de Huesos ataca desde el techo, el objetivo debe tirar DEX DC 12 o queda derribado.',
      },
      {
  ...
  },
  {
    ...
    hp: 22,
    attacks: [
      { name: 'Abrazo', bonus: 4, damage: '1d8', range: 'close', specialEffect: 'En impacto: el objetivo queda agarrado (STR DC 14 para liberarse).' },
    ],
    movement: { normal: 'near' },
    ...
    abilities: [
      {
        ...
        description: 'Cuando el Guardián recibe daño cortante o perforante, un frasco se rompe y libera gas tóxico en rango cercano. Todos en el área tiran CON DC 12 o sufren 1d4 de daño de veneno.',
      },
      {
        name: 'Agarrado',
  ...
  },
  {
    ...
    attacks: [
      ...
      { name: 'Elegía', bonus: 4, damage: '1d6', range: 'near', specialEffect: 'Daño psíquico. WIS DC 13 o el objetivo queda paralizado hasta el final de su siguiente turno.' },
    ],
    ...
    abilities: [
      {
        name: 'Elegía',
        description: 'El Eco toca una melodía fantasmal. Todos los enemigos en rango cercano deben tirar WIS DC 13 o quedan paralizados hasta el final de su siguiente turno. Usa esta habilidad en lugar de atacar.',
      },
      {
        name: 'No Es Él',
  ...
  },
  {
    ...
    attacks: [
      ...
      { name: 'Acorde Ritual', bonus: 5, damage: '2d6', range: 'far', specialEffect: 'Daño psíquico en área. Todos los enemigos en rango lejano tiran WIS DC 14 o sufren el daño.' },
    ],
    movement: { normal: 'near' },
    ...
    abilities: [
      {
        name: 'Acorde Ritual',
        description: 'Aldric toca su flauta de hueso. Todos los enemigos en la sala deben tirar WIS DC 14 o sufren 2d6 de daño psíquico. Usa esta habilidad cada 2 rondas.',
      },
      {
        name: 'Voz Cristalina',
...
const rooms = [
  {
    ...
    gmNotes: 'Esta sala es la entrada principal a las ruinas. La puerta norte está trabada (STR DC 10 para abrir). En las raíces secas hay un nido de 2 Masas Balbucientes que atacan si se molestan las raíces. Un registro cuidadoso (INT DC 12) revela un grabado en la pared: "Aquí yace el campanario de los que lloran".',
  ...
  },
  {
    ...
    gmNotes: 'La nave era la capilla principal del antiguo campanario. Los sollozos provienen del Pozo de las Voces (Sala 5). El altar tiene una cavidad oculta (INT DC 13) que contiene el Colgante de Piedra Sangre. Hay puertas al oeste (Sala 3), al este (Sala 4) y un corredor al sur (Sala 5). 1d4 Arañas de Huesos acechan en el techo y atacan al grupo que pase por debajo.',
  ...
  },
  {
    ...
    gmNotes: 'Hay 24 nichos, de los cuales 6 están vacíos (sus ocupantes se convirtieron en Masas Balbucientes). La baldosa hundida en x:3,y:9 es una trampa de foso: el suelo se abre a un pozo de 3 metros con estacas. Uno de los nichos (INT DC 14) contiene un compartimento secreto con el Anillo del Mortífero y 30 mo.',
    monsterIds: [],
  ...
  },
  {
    ...
    gmNotes: 'La sacristía era donde el clérigo guardaba sus implementos rituales. La mayoría está destruida, pero un registro (INT DC 12) revela 2 Velas Huecas intactas y un frasco de Aceite de Médula Ósea. El musgo fosforescente proporciona luz tenue. Un pasaje parcialmente bloqueado (STR DC 13) lleva a un pequeño espacio donde hay un cofre con 45 mo y un pergamino ilegible.',
    monsterIds: [],
  ...
  },
  {
    ...
    gmNotes: 'El pozo conecta con el nivel inferior (Sala 8, La Galería Ahogada). Las voces son residuos psíquicos de los rituales de Aldric. Cualquiera que escuche las voces durante más de 1 minuto debe tirar WIS DC 12 o sufrir 1d4 de daño psíquico. Las escaleras están resbaladizas (DEX DC 10 o caer al agua). El agua tiene 5 metros de profundidad y está helada. Un Guardián Hueco patrulla el borde del pozo.',
  ...
  },
  {
    ...
    gmNotes: 'El agua del pozo es una mezcla de sangre antigua y agua subterránea. No es venenosa, pero beber de ella causa náuseas (CON DC 11 o desventaja en tiradas durante 10 minutos). En el fondo del pozo (sumergirse, CON DC 13 para aguantar la respiración) hay un cofre de hierro sellado con 80 mo, 3 gemas de rubí (20 mo cada una) y un Testigo de Duelo.',
    monsterIds: [],
  ...
  },
  {
    ...
    gmNotes: 'Los sarcófagos contienen los restos de los primeros sujetos del Vaciado de Aldric. La sustancia aceitosa es Médula procesada — se puede recolectar 2 dosis de Aceite de Médula Ósea (INT DC 12 para extraer sin contaminar). La puerta sur tiene un glifo trampa que se activa al cruzar el umbral. Puerta al este hacia Sala 10.',
    monsterIds: [],
  ...
  },
  {
    ...
    gmNotes: 'Esta era la sala de trabajo de Aldric. La mujer en la jaula es Mira Soln, una curandera capturada. La figura inmóvil es Kaelith, un no-muerto "voluntario" que sirve a Aldric pero mantiene parte de su consciencia. Kaelith no atacará a menos que el grupo amenace el trabajo de Aldric. Si se le convence (CHA DC 13), revelará la ubicación de la puerta secreta al sur (x:24, y:14) que lleva a la Sala 11. 2 Guardianes Huecos protegen la sala.',
    monsterIds: ['monster-guardian-hueco'],
    treasure: 'Mesa: instrumental quirúrgico (15 mo como lote). Estantería: 3 pociones de curación (1d6 PG). Frasco especial: Tomo del Vaciado (dentro de un compartimento oculto en la estantería, INT DC 14).',
    traps: [],
  ...
  },
  {
    ...
    gmNotes: 'El puente tiene 2 metros de ancho (1 casilla) y 5 metros de largo. Pasar sin problemas requiere DEX DC 10. Si hay combate en el puente, los ataques fallidos por 5 o más hacen que el atacante deba tirar DEX DC 12 o caer. Caer al abismo es muerte instantánea. Un Eco de Aldric aparece a mitad del puente y bloquea el paso. Hay una puerta secreta (INT DC 15) en la pared este a mitad del puente que lleva a la Antecámara Sellada (Sala 12).',
  ...
  },
  {
    ...
    gmNotes: 'Esta es la sala del jefe final. Aldric Voss está sentado en su trono. Los dos sarcófagos contienen: el izquierdo, el cuerpo preservado de Sera (su hija); el derecho, un sarcófago vacío preparado para un nuevo ritual. Al inicio del combate, Aldric invoca 1d4 Masas Balbucientes de grietas en las paredes. Aldric no ataca de inmediato — primero habla, explicando que "ya casi termina" y que Sera "volverá pronto". Si el grupo muestra el Colgante de Piedra Sangre, Aldric pierde su primer turno llorando. Si destruyen el sarcófago de Sera (CA 10, 15 PG), Aldric entra en furia (+2 a ataques, -2 a CA). Hay tres posibles finales: 1) Matar a Aldric, 2) Convencerle de parar (CHA DC 16, con ventaja si leyeron las confesiones), 3) Completar el ritual (consecuencias terribles). Victoria: el temblor cesa, los no-muertos caen.',
...
const npcs = [
  ...
  },
  {
    ...
    stats: {
      ...
      alignment: 'chaotic',
      abilities: [
        { name: 'Acorde Ritual', description: 'Toca su flauta. Todos en la sala: WIS DC 14 o 2d6 psíquico.' },
...
const randomEncounters = [
  {
    ...
    entries: [
      {
        roll: 2,
        description: 'Un temblor sacude la sala. Todos tiran DEX DC 12 o caen al suelo. Los objetos sueltos se caen de los estantes.',
      },
      {
        roll: 3,
      ...
      {
        roll: 4,
        description: 'Una Araña de Huesos desciende del techo en silencio. Tiro de percepción (WIS DC 13) o sorprende al grupo.',
        monsterIds: ['monster-arana-huesos'],
        quantity: '1',
      },
      {
        roll: [5, 6],
        description: 'Se escucha una melodía de flauta lejana y melancólica. Todos deben tirar WIS DC 11 o sentirse compelidos a avanzar hacia el sonido durante 1 ronda.',
      },
      {
        roll: [7, 8],
      ...
      {
        roll: 9,
        description: 'Un Guardián Hueco pasa patrullando. Si el grupo se esconde (DEX DC 12), no los detecta. Si los detecta, ataca.',
        monsterIds: ['monster-guardian-hueco'],
        quantity: '1',
      },
      {
      ...
      {
        roll: 11,
        description: 'Las velas y antorchas parpadean y casi se apagan. WIS DC 12 o cada personaje experimenta una alucinación de su peor miedo durante 1 ronda (desventaja en todo).',
      },
      {
        roll: 12,
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          content: 'Si los aventureros convencen a Aldric de detenerse (CHA DC 16, con ventaja si leyeron las confesiones en la Antecámara), Aldric deja de tocar y llora abrazando el sarcófago de Sera. Tras un largo silencio, acepta que Sera no volverá. El ritual se deshace lentamente: los temblores cesan, los no-muertos caen, pero el proceso toma días en lugar de ser instantáneo.\n\nAldric se entrega voluntariamente. Su destino queda en manos de la prefecta: puede ser ejecutado, encarcelado, o exiliado. Si los aventureros abogan por clemencia, Orvana puede aceptar el exilio (CHA DC 13 adicional). Aldric se marcha al amanecer, solo, sin la flauta, que deja sobre la tumba de Sera.\n\nLa recompensa se paga. Ashenveil tarda en sanar, pero sana. Y la flauta, dejada sobre la tumba, nunca vuelve a sonar.',
          sortOrder: 2,
        },
        {
          id: 'lore-final-3',
