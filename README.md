...
- [ ] **JSON-based extensible data** -- drop-in content packs for homebrew monsters, spells, items
- [ ] **AI Integration** -- ChatGPT-powered GM assistant for encounter descriptions, NPC dialogue, rulings
- [ ] **Session export/import** -- save full sessions as JSON files for backup and sharing
- [ ] **PWA support** -- offline compendium access, install prompt
- [ ] **Sound effects** -- dice rolling, torch sizzle, combat sounds
